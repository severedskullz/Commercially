...
namespace Commercially.Common.GUI.Tabs
{
    public class GuiBlockEntityDebugTab : ModularTab
    {
        ...
        public override void Compose(GuiComposer composer, ElementBounds rootBounds)
        {
            ...
            rootBounds.WithChildren(nameLabel, ownableTypeLabel, isAdminOwnedLabel, ownerNameLabel, ownerUIDLabel, idLabel);

            ElementBounds primaryMatLabel = ElementBounds.FixedSize(400, 30).FixedUnder(idLabel);
