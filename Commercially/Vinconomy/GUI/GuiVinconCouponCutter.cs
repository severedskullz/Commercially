...
namespace Vinconomy.GUI
{
    public class GuiVinconCouponCutter : GuiDialogBlockEntity
    {
        ...
        public GuiVinconCouponCutter(string dialogTitle, BECouponCutterBehavior behaviour, InventoryBase inventory, BlockPos pos, ICoreClientAPI coreClientAPI) : base(dialogTitle, inventory,  pos, coreClientAPI)
        {
            ...
            CouponPrinter = behaviour;
            CommerciallyModSystem modSystem = capi.ModLoader.GetModSystem<CommerciallyModSystem>();
            OwnableRegistration[] allRegisters = modSystem.OwnableRegistry.GetOwnablesForOwner(coreClientAPI.World.Player.PlayerUID);
