...
{
    public class BEMealStallBehavior : BEStallBehavior
    {
        public BEMealStallBehavior(BlockEntity blockentity) : base(blockentity)
        {
        }
        ...
        public ServingCapacityAggregatedSlots GetRequiredTools(IPlayer player, int stallSlot)
        {
