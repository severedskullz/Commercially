...
namespace Vinconomy.Map
{
    public class ShopMapComponent : MapComponent
    {
        ...
        private OwnableRegistration waypoint;
        ...
        public ShopMapComponent(int waypointIndex, OwnableRegistration waypoint, ShopMapLayer wpLayer, ICoreClientAPI capi) : base(capi)
        {
